      ...
      <style>{`
        ...
        * {
        ...
        .primary-button:hover {
          transform: translateY(-2px);
          box-shadow: 0 10px 25px rgba(23,121,107,0.22);
        }
      ...
      <section className="relative z-10 mx-auto max-w-6xl px-6 pb-20 pt-20 md:px-8 md:pb-28 md:pt-28">
        <div className="grid items-center gap-14 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <div className="relative">
            <div className="hero-card rounded-3xl p-7 md:p-9">
        ...
        {EXPERIENCE.map((experience) => (
          <Reveal key={experience.id}>
            <div className="relative pl-7 md:pl-10">
              ...
              <div
                className="rounded-2xl border bg-white p-6 md:p-9"
                style={{ borderColor: COLORS.line }}
              >
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {Object.entries(SKILLS).map(
            ([category, technologies], index) => (
              ...
              >
                <div
                  className="group rounded-2xl border bg-white p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg md:p-7"
                  style={{ borderColor: COLORS.line }}
                >
          ...
          <div className="relative z-10 grid gap-12 md:grid-cols-[1fr_auto] md:items-end">
            <div>
              ...
              >
                ...
                involving software development, QA automation,
